      ...
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        <div className="grid md:grid-cols-[1fr_2fr] gap-12 items-start">
          ...
          >
            ...
            <div className="relative aspect-[3/4] bg-neutral-100 border border-black/10 overflow-hidden">
              <img
          ...
          <div className="space-y-8">
            ...
            >
              <div>
                <h3 className="text-foreground mb-2 uppercase font-bold text-accent">Location</h3>
                <p className="text-muted-foreground">Mysore, India</p>
              </div>
              <div>
                <h3 className="text-foreground mb-2 uppercase font-bold text-accent">Focus</h3>
                <p className="text-muted-foreground">AI, Machine Learning, Data Analytics</p>
              </div>
              <div>
                <h3 className="text-foreground mb-2 uppercase font-bold text-accent">Hobbies</h3>
                <p className="text-muted-foreground">Singing, Writing Songs, Photography</p>
              </div>
              <div>
                <h3 className="text-foreground mb-2 uppercase font-bold text-accent">Languages</h3>
                <p className="text-muted-foreground">English, Kannada, Tamil, Hindi</p>
              </div>
              <div>
                <h3 className="text-foreground mb-2 uppercase font-bold text-accent">LinkedIn</h3>
                <a
                  href="https://www.linkedin.com/in/beulah-deva-4576602b7?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                  target="_blank"
                ...
                <div className="space-y-6">
                  {education?.map((edu) => (
                    <div key={edu.id} className="space-y-1">
                      <h3 className="text-foreground font-mono font-bold uppercase">{edu.institution}</h3>
