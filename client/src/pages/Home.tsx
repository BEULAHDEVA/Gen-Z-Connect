      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="relative w-full aspect-square max-w-md">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-card border border-black/10 p-6 w-64 backdrop-blur-xl rotate-[-5deg] hover:rotate-0 transition-transform duration-500">
              ...
              <div className="space-y-2 font-mono text-sm">
                ...
                <div className="text-black/80">Training AI...</div>
                <div className="text-black/80">[====================] 100%</div>
